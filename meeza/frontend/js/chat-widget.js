...
function initChatWidget() {
  ...
  widget.innerHTML = `
    ...
    <button class="chat-fab" id="chatFabBtn" aria-label="الدردشة مع الدعم"><img src="images/icons/eco_24dp_E3E3E3_FILL0_wght400_GRAD0_opsz24.svg" alt="الدردشة مع الدعم" class="chat-fab-icon"></button>
  ...
  setTimeout(() => { if (!chatOpen) bubbleTip.classList.remove("hidden"); }, 2000);
